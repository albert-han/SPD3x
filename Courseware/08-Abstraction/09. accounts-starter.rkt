...
;; remove acts that satisfy pred predicate
...
(check-expect (local [(define (debtor? act) (negative? (node-bal act)))]
                (remove-acts debtor? (make-node 4 "Mrs. Doubtfire" -3
                                                false 
                                                (make-node 7 "Mr. Natural" 13 false false))))
              (make-node 7 "Mr. Natural" 13 false false))
...
(check-expect (remove-odd-characters (make-node 1 "a" 10 false false)) false)
(check-expect (remove-odd-characters (make-node 1 "ab" 10 false false)) (make-node 1 "ab" 10 false false))
(check-expect (remove-odd-characters (make-node 2 "a" 10 
                                                (make-node 1 "ab" 10 false false)
                                                (make-node 3 "cd" 10 false false)))
              (make-node 3 "cd" 10 
                         (make-node 1 "ab" 10 false false)
                         false))
(check-expect (remove-odd-characters (make-node 5 "ab" 10
                                                (make-node 3 "c" 10 
                                                           (make-node 1 "de" 10 false false)
                                                           (make-node 4 "fg" 10 false false))
                                                (make-node 6 "hi" 10 false false)))
              (make-node 5 "ab" 10 
                         (make-node 4 "fg" 10
                                    (make-node 1 "de" 10 false false)
                                    false)
...
(check-expect (charge-fee (make-node 1 "Mr. Rogers" 22 false false)) 
              (make-node 1 "Mr. Rogers" 19 false false))
(check-expect (charge-fee (make-node 4 "Mrs. Doubtfire" -3
                                     false
                                     (make-node 7 "Mr. Natural" 13 false false)))
...
(define (charge-fee act)
  (local [(define (c1 id name bal rnodel rnoder) (make-node id name (- bal 3) rnodel rnoder))]
    (fold-act c1 false act)))
